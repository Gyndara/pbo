 ...
 * @author bisma
 */
public class DeleteProductPopUp extends javax.swing.JDialog {

    /**
     * Creates new form UpdatePopUp1
     */
    public DeleteProductPopUp(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        pack();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Input SKU Code");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteProductPopUp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteProductPopUp().setVisible(true);
            }
        });
    }
