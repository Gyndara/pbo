 ...
 * @author USER
 */
public class AddProductViesw extends javax.swing.JFrame {

    /**
     * Creates new form AddProductViesw
     */
    public AddProductViesw() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddProductViesw.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddProductViesw().setVisible(true);
            }
        });
    }
