 ...
 * @author bisma
 */
public class SizePopUp1 extends javax.swing.JDialog {
    ...
    public SizePopUp1(MainWindow window){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SizePopUp1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SizePopUp1().setVisible(true);
            }
        });
    }
